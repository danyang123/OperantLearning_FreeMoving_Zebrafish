...
global PB6 PB7 DOPort us_left  us_num_L us_right  us_num_R device
...
time.acq_tst_Interval=10*60;  %10
...
%% Projector
screen_coordinate=[150 150 200 200]; %projector
PsychDefaultSetup(2);
screens = Screen('Screens');
screenNumber = max(screens);
load('C:\Users\ldy12\Desktop\Img.mat');
Img1 = Img{1};
Img2 = Img{2};
...
STOPPED=1;
us_left=[];  us_num_L=0;  us_right=[];  us_num_R=0;
